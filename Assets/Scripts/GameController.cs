...
public class GameController : MonoBehaviour
{
    ...
    {
        health = maxHealth;
        healthImage.fillAmount = Mathf.Lerp(healthImage.fillAmount, health / maxHealth, lerpSpeed * Time.deltaTime); //health / maxHealth;
        UpdateTower(0);
        gameOver = false;
    ...
    void SpawnEnemy()
    {
        Instantiate(enemies[Random.Range(0, 3)], spawnPosition.transform.position, Quaternion.Euler(0, 0, -90));
